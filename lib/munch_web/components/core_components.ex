defmodule MunchWeb.CoreComponents do
  ...
  ## Examples
      ...
      <.flash kind={:info} phx-mounted={JS.show(to: "#flash")}>Welcome Back!</.flash>
  """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MunchWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MunchWeb.Gettext, "errors", msg, opts)
    end
  end
