...
urlpatterns = [
    ...
    path(
        "restaurants/new/done/",
        views.NewRestaurantDoneView.as_view(),
        name="new_restaurant_done",
    ),
    path(
    ...
    path(
        "user/<username>/logs/<int:pk>/",
        views.LogDetailView.as_view(),
        name="log_detail",
    ),
    path(
        "user/<username>/logs/<int:pk>/edit/",
        views.LogEditView.as_view(),
        name="log_edit",
    ),
    path(
        "user/<username>/reviews/", views.UserReviewsView.as_view(), name="new_review"
    ),
    path(
        "user/<username>/review/<slug:slug>/",
        views.ReviewDetailView.as_view(),
        name="review_detail",
    ),
    path(
        "user/<username>/review/<slug:slug>/edit/",
